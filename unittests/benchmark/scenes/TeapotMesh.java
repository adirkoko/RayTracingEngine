...
/**
 * Triangle mesh data for the benchmark teapot scenes.
 */
final class TeapotMesh {
    ...
    /**
     * Adds the teapot triangles to a geometry collection.
     *
     * @param geometries target geometry collection
     * @param color      emission color
     * @param mat        material shared by the teapot triangles
     */
    static void addTo(Geometries geometries, Color color, Material mat) {
