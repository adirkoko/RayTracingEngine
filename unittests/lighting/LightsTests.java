...
public class LightsTests {
    ...
    public void sphereMultipleLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(new Color(400, 300, 300), new Vector(1, -1, -0.5)));
        scene1.lights.add(new PointLight(new Color(500, 300, 0), new Point(-50, 50, 50)).setKl(0.0001).setKq(0.00001));
        scene1.lights.add(new SpotLight(new Color(200, 200, 800), new Point(-50, -50, 25), new Vector(1, 1, -0.5)).setKl(0.0001).setKq(0.000005));
    ...
    public void trianglesMultipleLights() {
        ...
        scene2.lights.add(new PointLight(new Color(500, 250, 250), new Point(50, 50, -100)).setKl(0.0001).setKq(0.00001));
        scene2.lights.add(new SpotLight(new Color(200, 200, 200), new Point(30, 10, -100), new Vector(-2, -2, -2)).setKl(0.0001).setKq(0.000005));
