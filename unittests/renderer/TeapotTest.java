...
public class TeapotTest {
    ...
    /**
     * Teapot with no anti-aliasing test.
     */
    @Test
    public void Teapot_NoAntiAliasing() {
        Camera.getBuilder()
                .setDirection(new Vector(0, 0, 1), new Vector(0, 1, 0))
                .setLocation(new Point(0, 0, -1000))
                .setVpDistance(1000)
                .setVpSize(200, 200)
                .setImageWriter(new ImageWriter("Teapot_NoAntiAliasing", 1001, 1001))
                .setRayTracer(new SimpleRayTracer(createTeapotScene()))
                .build()
                .renderImage()
    ...
    /**
     * Teapot with anti-aliasing test.
     */
    @Test
    public void Teapot_WithAntiAliasing() {
        Camera.getBuilder()
                .setDirection(new Vector(0, 0, 1), new Vector(0, 1, 0))
                .setLocation(new Point(0, 0, -1000))
                .setVpDistance(1000)
                .setVpSize(200, 200)
                .setImageWriter(new ImageWriter("Teapot_WithAntiAliasing", 1001, 1001))
                .setSampleSize(17)
                .setRayTracer(new SimpleRayTracer(createTeapotScene()))
                .build()
                .renderImage()
    ...
    /**
     * Teapot with adaptive anti-aliasing test.
     */
    @Test
    public void Teapot_WithAdaptiveAntiAliasing() {
        Camera.getBuilder()
                .setDirection(new Vector(0, 0, 1), new Vector(0, 1, 0))
                .setLocation(new Point(0, 0, -1000))
                .setVpDistance(1000)
                .setVpSize(200, 200)
                .setImageWriter(new ImageWriter("Teapot_WithAdaptiveAntiAliasing", 1001, 1001))
                .setSampleSize(17)
